...
namespace Graphics::Vulkan {
	VulkanFramebuffer_OLD::~VulkanFramebuffer_OLD() = default;

	void VulkanFramebuffer_OLD::Release() {
		vkDestroyFramebuffer(m_device->getLogicalDevice(), m_framebuffer, nullptr);
	}

	void VulkanFramebuffer_OLD::CreateFramebuffer(std::shared_ptr<VulkanDevice> device, VkRenderPass renderPass,
	...
	void VulkanFramebuffer_OLD::RecreateFramebuffer(uint32_t width, uint32_t height, VkImageView swapchainImageView,
	...
	void VulkanFramebuffer_OLD::buildFramebuffer(std::vector<VkImageView> attachments) {
