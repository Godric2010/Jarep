...
#ifndef JAREP_VULKANFRAMEBUFFER_OLD_HPP
#define JAREP_VULKANFRAMEBUFFER_OLD_HPP
...
namespace Graphics::Vulkan {
	...
	class VulkanFramebuffer_OLD final {
		public:
			explicit VulkanFramebuffer_OLD(const VkExtent2D framebufferExtent) {
				m_framebuffer = nullptr;
				m_framebufferExtent = framebufferExtent;
			}

			~VulkanFramebuffer_OLD();
...
#endif//JAREP_VULKANFRAMEBUFFER_OLD_HPP
